    ...
    <SheetPortal>
      ...
      >
        ...
        <SheetPrimitive.Close
          className="absolute top-4 right-4 rounded-xs opacity-70 hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:ring-ring transition-opacity"
        >
          <X className="h-4 w-4" />
...
function SheetHeader(props: React.ComponentProps<"div">) {
  return <div data-slot="sheet-header" className="flex flex-col gap-1.5 p-4" {...props} />
}

function SheetFooter(props: React.ComponentProps<"div">) {
  return <div data-slot="sheet-footer" className="mt-auto flex flex-col gap-2 p-4" {...props} />
}
...
function SheetDescription(props: React.ComponentProps<typeof SheetPrimitive.Description>) {
  return <SheetPrimitive.Description data-slot="sheet-description" className="text-muted-foreground text-sm" {...props} />
}
